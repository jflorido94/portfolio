...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      ...
      <p>Soy <span class="typed" data-typed-items="Web Developer, Back-end Developer, Game Developer"></span></p>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <img src="assets/img/lenguajes.png" class="img-fluid" alt="">
          </div>
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Nacimiento:</strong> <span>9 de Febrero 1994</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Web:</strong> <span>www.jflorido94.es</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Ciudad:</strong> <span>Paterna del Campo, Huelva</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Edad:</strong> <span>28</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Grado:</strong> <span>Junior</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>jflorido94@hotmail.com</span></li>
                </ul>
              </div>
            </div>
            <p>
